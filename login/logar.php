		...
		<section class='box'>
			...
			<form action="autenticacao.php" method="post">
				...
				<div class="etc-login-form">
					<!-- <p><a href="registrar.php">Criar nova conta</a></p> -->
				</div>
			</form>		  
		</section>
</div>
...
<div style='text-align: center;'>
  ...
  <p style='color:#000;'> Copyrights © 2018 | <b>Motogen</b>. Todos os direitos reservados a este site da Web. Este site da web é de propriedade da empresa Motogen.</p>
</div>

</body>
<?php if (isset($_SESSION['msg'])) { ?>
  <!-- Se tiver mnesagem mostra em um alerta e remove da session -->
  <script>
    alert("<?=$_SESSION['msg']?>");
  </script>
<?php
